                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <h6 class="mb-4">รายละเอียดโครงการ</h6>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc1'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="u_name" class="col-sm-2 col-form-label">บทที่ 1 บทนำ</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc2'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">บทที่ 2 งานวิจัยที่เกี่ยวข้อง</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc3'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">บทที่ 3 งานวิจัยที่เกี่ยวข้อง</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc4'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">บทที่ 4 ผลการวิเคราะห์ข้อมูล</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc5'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">บทที่ 5 สรุปผล อภิปรายผล</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc6'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">บรรณานุกรม</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc7'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก ก.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc8'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก ข.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc9'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก ค.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc10'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก ง.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc11'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก จ.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc12'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก ฉ.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc13'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก ช.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc14'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ภาคผนวก ซ.</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc15'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">ผู้จัดทำ</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc16'];?> </a>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">เอกสาร รวม PDF ทั้งหมด</label>
                                    <div class="col-sm-5">
                                    <a href="signin.php "onclick = "return confirm('โปรดเข้าสู่ระบบ')"> <?php echo $rs['doc17'];?> </a>
                                    </div>
                                </div>
