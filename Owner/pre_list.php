...
<?php
 if (isset($_POST['add'])) {
    ...
    $sql = mysqli_query($conn, "INSERT INTO tb_pre( pre_name) VALUES('$pre_name')");
        if ($sql) {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">เพิ่มคำนำหน้าชื่อ</h5>
      ...
      <form  method="post" >
            <div class="modal-body">
                ...
                <label for="name" class="form-label mt-3">คำนำหน้าชื่อ</label>
                <input type="text" name="pre_name" class="form-control" placeholder="คำนำหน้าชื่อ">
...
?>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- <p Align=right><button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModal1" href ='pre_list.php?pre_id=<?php echo $rs['pre_id']?>'><i class="fas fa-plus"></i>&nbsp;เพิ่มข้อมูล</button></p>
                                     -->
                                    </tr>
                                </thead>
                                <tbody>
  ...
  ?>
                                        <td><?php echo $no;?></td>
                                        <td><?php echo $rs['pre_name']?></td>
                                        <td> 
                                            <a class = "btn btn-warning t"  href ='pre_list.php?pre_id=<?php echo $rs['pre_id']?>'><i class='fas fa-edit'></i>แก้ไข</button></a> 
                                            <!-- <a class="btn btn-warning t" data-toggle="modal" data-target="#exampleModal2" href="pre_edit.php?pre_id=<?php echo $rs['pre_id'];?>" ><i class='fas fa-edit'></i> แก้ไข</a> -->
...
$no++;
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        <h4 class="mb-4">ปรับปรุงข้อมูลคำนำหน้าชื่อ</h4>
                        <form method="post" action="?page=update">
                        <!-- <div class="row mb-3"> -->
                                    <!-- <label for="pre_id" class="col-sm-2 col-form-label">ลำดับ</label> -->
                                    <!-- <div class="col-sm-10"> -->
                                        <input type="hidden" name="pre_id" class="form-control" id="pre_id" readonly value=<?php echo $rs['pre_id'];?> > 
                                    <!-- </div>
                                </div> -->
                                <div class="row mb-3">
                                    <label for="pre_name" class="col-sm-3 col-form-label">คำนำหน้าชื่อ</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="pre_name" class="form-control" id="pre_name" value=<?php echo $rs['pre_name'];?> >
                                    </div>
                                </div>
