...
?>
            ...
            <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h4 class="mb-4">ข้อมูลผู้ดูแลระบบ</h6>
                            <form method="post" action="?page=update">
                            <p Align=right> <a class = "btn btn-warning t"  href ='admin_edit.php?u_name=<?php echo $_SESSION ["mem_name"];?>'><i class='fas fa-edit'></i>แก้ไข</button></a></p>
                                

                            
 
                            <div align="center">
                            <td><img src="../memberimg/<?php echo $rs['uimg']; ?>" width="150"></td>
                            </div>
