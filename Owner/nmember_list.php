...
?>
  ...
  <tr>
    ...
    <td><?php echo $rs['pre_name'],$rs['r_name'],$rs['surname'];?></td>
    ...
    <td>
               ...
               <!-- <div class="btn-group">
                        ...
                        <a class="dropdown-item" href="nupdate_status.php?pk=<?php echo $rs['u_name'];?>&status_id=1">ผู้ดูแลระบบ</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="nupdate_status.php?pk=<?php echo $rs['u_name'];?>&status_id=2">ครูที่ปรึกษา</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="nupdate_status.php?pk=<?php echo $rs['u_name'];?>&status_id=3">นักเรียน/นักศึกษา</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="nupdate_status.php?pk=<?php echo $rs['u_name'];?>&status_id=0">ไม่อนุญาต</a>
                         <div class="dropdown-divider"></div> 
                        </div>
                        </div> -->
    </td>
